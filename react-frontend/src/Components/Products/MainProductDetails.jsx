            ...
            <div className="swiper-slide product-card">
              <div className="pc__img-wrapper">
                <a href="product1_simple.html">
                    <img
                      loading="lazy"
                      src="https://uomo-html.flexkitux.com/images/products/product_3.jpg"
                      width={330}
                      height={400}
                    ...
                    <img
                      loading="lazy"
                      src="https://uomo-html.flexkitux.com/images/products/product_3-1.jpg"
                      width={330}
                      height={400}
                      alt="Cropped Faux leather Jacket"
              ...
              <div className="pc__info position-relative">
                ...
                <h6 className="pc__title">
                  <Link to="/product/1">Kirby T-Shirt</Link>
                </h6>
            ...
            <div className="swiper-slide product-card">
              <div className="pc__img-wrapper">
                <a href="product1_simple.html">
                  <img
                    loading="lazy"
                    src="https://uomo-html.flexkitux.com/images/products/product_1.jpg"
                    width={330}
                    height={400}
                    alt="Cropped Faux leather Jacket"
                    className="pc__img"
                  ...
                  <img
                    loading="lazy"
                    src="https://uomo-html.flexkitux.com/images/products/product_1-1.jpg"
                    width={330}
                    height={400}
                    alt="Cropped Faux leather Jacket"
                    className="pc__img pc__img-second"
              ...
              <div className="pc__info position-relative">
                <p className="pc__category">Dresses</p>
                <h6 className="pc__title">
                  <Link to="/product/1">Cropped Faux Leather Jacket</Link>
                </h6>
                <div className="product-card__price d-flex">
            ...
            <div className="swiper-slide product-card">
              <div className="pc__img-wrapper">
                <a href="product1_simple.html">
                  <img
                    loading="lazy"
                    src="https://uomo-html.flexkitux.com/images/products/product_2.jpg"
                    width={330}
                    height={400}
                    alt="Cropped Faux leather Jacket"
                    className="pc__img"
                  ...
                  <img
                    loading="lazy"
                    src="https://uomo-html.flexkitux.com/images/products/product_2-1.jpg"
                    width={330}
                    height={400}
                    alt="Cropped Faux leather Jacket"
                    className="pc__img pc__img-second"
              ...
              <div className="pc__info position-relative">
                <p className="pc__category">Dresses</p>
                <h6 className="pc__title">
                  <Link to="/product/1">Calvin Shorts</Link>
                </h6>
                <div className="product-card__price d-flex">
            ...
            <div className="swiper-slide product-card">
              <div className="pc__img-wrapper">
                <a href="product1_simple.html">
                  <img
                    loading="lazy"
                    src="https://uomo-html.flexkitux.com/images/products/product_6.jpg"
                    width={330}
                    height={400}
                    alt="Cropped Faux leather Jacket"
                    className="pc__img"
                  ...
                  <img
                    loading="lazy"
                    src="https://uomo-html.flexkitux.com/images/products/product_6-1.jpg"
                    width={330}
                    height={400}
                    alt="Cropped Faux leather Jacket"
                    className="pc__img pc__img-second"
            ...
            <div className="swiper-slide product-card">
              <div className="pc__img-wrapper">
                <a href="product1_simple.html">
                  <img
                    loading="lazy"
                    src="https://uomo-html.flexkitux.com/images/products/product_7.jpg"
                    width={330}
                    height={400}
                    alt="Cropped Faux leather Jacket"
                    className="pc__img"
                  ...
                  <img
                    loading="lazy"
                    src="https://uomo-html.flexkitux.com/images/products/product_7-1.jpg"
                    width={330}
                    height={400}
                    alt="Cropped Faux leather Jacket"
                    className="pc__img pc__img-second"
            ...
            <div className="swiper-slide product-card">
              <div className="pc__img-wrapper">
                <a href="product1_simple.html">
                  <img
                    loading="lazy"
                    src="https://uomo-html.flexkitux.com/images/products/product_4.jpg"
                    width={330}
                    height={400}
                    alt="Cropped Faux leather Jacket"
                    className="pc__img"
                  ...
                  <img
                    loading="lazy"
                    src="https://uomo-html.flexkitux.com/images/products/product_4-1.jpg"
                    width={330}
                    height={400}
                    alt="Cropped Faux leather Jacket"
                    className="pc__img pc__img-second"
            ...
            <div className="swiper-slide product-card">
              <div className="pc__img-wrapper">
                <a href="product1_simple.html">
                  <img
                    loading="lazy"
                    src="https://uomo-html.flexkitux.com/images/products/product_5.jpg"
                    width={330}
                    height={400}
                    alt="Cropped Faux leather Jacket"
                    className="pc__img"
                  ...
                  <img
                    loading="lazy"
                    src="https://uomo-html.flexkitux.com/images/products/product_5-1.jpg"
                    width={330}
                    height={400}
                    alt="Cropped Faux leather Jacket"
                    className="pc__img pc__img-second"
            ...
            <div className="swiper-slide product-card">
              <div className="pc__img-wrapper">
                <a href="product1_simple.html">
                  <img
                    loading="lazy"
                    src="https://uomo-html.flexkitux.com/images/products/product_8.jpg"
                    width={330}
                    height={400}
                    alt="Cropped Faux leather Jacket"
                    className="pc__img"
                  ...
                  <img
                    loading="lazy"
                    src="https://uomo-html.flexkitux.com/images/products/product_8-1.jpg"
                    width={330}
                    height={400}
                    alt="Cropped Faux leather Jacket"
                    className="pc__img pc__img-second"
